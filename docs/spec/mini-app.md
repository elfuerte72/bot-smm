...
4. **CHANNEL_SNAPSHOT_INTERVAL_MINUTES** — оставить 60 или сделать чаще (например 15)? Чем чаще, тем плотнее sparkline, но больше нагрузка на Bot API. Рекомендую 60 для старта.
